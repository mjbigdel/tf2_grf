...
from distdeepq_FullEpisode.agent import Agent
from distdeepq_FullEpisode.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from distdeepq_FullEpisode.network import Network
from distdeepq_FullEpisode.utils import discount_with_dones, init_env
...
class Learn:
    ...
    @tf.function
    def compute_loss(self, obses_t, actions, rewards, obses_tp1, dones, weights, fps=None):
        """
    ...
    @tf.function()
    def train(self, obses_t, actions, rewards, obses_tp1, dones, weights, fps=None):
        with tf.GradientTape() as tape:
            losses, td_errors = self.compute_loss(obses_t, actions, rewards, obses_tp1, dones, weights, fps)

...
from dqn_ma_1_dict.dqn_agent import DeepQAgent, MAgent
    ...
    for t in range(total_timesteps):
        ...
        for agent_name in agent_names:
            ...
            if replay_buffer is not None:
                replay_buffer.add(obs_dict[agent_name], action_dict[agent_name], rew_dict[agent_name],
                                  new_obs_dict[agent_name], float(done_dict['__all__']))
        ...
        if done_dict['__all__'] and print_freq is not None and len(episode_rewards) % print_freq == 0:
